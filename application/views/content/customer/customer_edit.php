...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <label class="col-md-4" for="email"> <span class="required">*</span>
                    Email
                </label>
                <div class="col-md-8">
            ...
            <div class="form-group">
                <label class="col-md-4" for="phone"> <span class="required">*</span>
                    Telp
                </label>
                <div class="col-md-8">
            ...
            <div class="form-group">
                <label class="col-md-4" for="phone_kantor"> <span class="required"></span>
                    Telp Kantor
                </label>
                <div class="col-md-8">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="col-md-4" for="regencies_id"> <span class="required">*</span>
                    Kota
                </label>
                <div class="col-md-8">
            ...
            <div class="form-group">
                <label class="col-md-4" for="alamat"> <span class="required">*</span>
                    Alamat
                </label>
                <div class="col-md-8">                

...
CREATE TABLE IF NOT EXISTS `m_business` (
  ...
  `nama_business` varchar(30) DEFAULT NULL,
  `province_id` int(11) DEFAULT NULL,
  `regencies_id` int(11) DEFAULT NULL,
  `district_id` int(11) DEFAULT NULL,
  `alamat_business` text,
  `tlp_business` varchar(20) DEFAULT NULL,
  `email_business` varchar(255) DEFAULT NULL,
  `website_business` varchar(50) DEFAULT NULL,
  `instagram_business` varchar(50) DEFAULT NULL,
  `twitter_business` varchar(30) DEFAULT NULL,
  `facebook_business` varchar(70) DEFAULT NULL,
  `description_business` text,
  `img_business` varchar(50) DEFAULT NULL,
  `register_business` varchar(30) DEFAULT NULL,
  `stok` int(1) DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `m_coa` (
  `id_m_coa` int(20) NOT NULL AUTO_INCREMENT,
  `is_cash_bank` int(20) NOT NULL DEFAULT '0',
  `id_business` int(20) NOT NULL DEFAULT '0',
  `kode` varchar(50) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `m_coa_jenis` (
  `id_m_coa_jenis` int(11) NOT NULL AUTO_INCREMENT,
  `id_business` varchar(50) DEFAULT NULL,
...
INSERT INTO `m_coa_jenis` (`id_m_coa_jenis`, `id_business`, `nama`, `keterangan`, `status`) VALUES
	(1, '1', 'Kas/Bank', NULL, 1),
	(2, '1', 'Piutang', NULL, 1),
	(3, '1', 'Persediaan', NULL, 1),
	(4, '1', 'Aset Lancar Lainnya', NULL, 1),
	(5, '1', 'Aset Tetap', NULL, 1),
	(6, '1', 'Akumulasi Depresiasi', NULL, 1),
	(7, '1', 'Hutang', NULL, 1),
	(8, '1', 'Hutang Lancar Lainnya', NULL, 1),
	(9, '1', 'Modal', NULL, 1),
	(10, '1', 'Pendapatan', NULL, 1),
	(11, '1', 'Pembelian', NULL, 1),
...
CREATE TABLE IF NOT EXISTS `m_customer` (
  ...
  `phone_kantor` varchar(20) DEFAULT NULL,
  `alamat` text,
  `province_id` int(11) DEFAULT NULL,
  `regencies_id` int(11) DEFAULT NULL,
  `district_id` int(11) DEFAULT NULL,
...
-- Dumping data for table aio_accounting.m_customer: ~3 rows (approximately)
/*!40000 ALTER TABLE `m_customer` DISABLE KEYS */;
INSERT INTO `m_customer` (`id_customer`, `id_business`, `nama`, `email`, `phone`, `phone_kantor`, `alamat`, `province_id`, `regencies_id`, `district_id`, `status`) VALUES
	(1, 1, 'Customer edit', 'mailedit@mail.com', '123123123444', '123123123444', 'asdsadfasdf edit', 1, 3402, 1, 1),
	(2, 1, 'supplier coba', 'coba@mail.com', '123123123123', '', 'asdasdasd asdasdasd', NULL, 3578, 3404, 1),
	(3, 1, 'nama sup1', 'email@sup1.com', '242342342342', '242342342342', 'asdasd asdasdasd', NULL, 3404, NULL, 1),
	(4, 1, 'customer baru', 'customer@mail.com', '123123123123', '564564564554', 'asduasydu asiduuiasd aisudiausfr iasiuasd\r\niausdiuas aksidiasud asidoaisdo', NULL, 3509, NULL, 1),
	(5, 1, 'lsdljsdl', 'jsjerljs', 'osdio', 'oeortieo', 'sdhfksdkfsldf', NULL, 1102, NULL, 1);
/*!40000 ALTER TABLE `m_customer` ENABLE KEYS */;

-- Dumping structure for table aio_accounting.m_item
CREATE TABLE IF NOT EXISTS `m_item` (
  ...
  `harga` int(200) NOT NULL DEFAULT '0',
  `is_have_stock` int(1) DEFAULT NULL,
  `status` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id_item`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1;

-- Dumping data for table aio_accounting.m_item: ~6 rows (approximately)
/*!40000 ALTER TABLE `m_item` DISABLE KEYS */;
INSERT INTO `m_item` (`id_item`, `id_business`, `code`, `nama_item`, `satuan`, `foto`, `harga`, `is_have_stock`, `status`) VALUES
	(1, 1, 'ITEM00000001', 'rokok', 1, '', 0, 1, 1),
	(2, 1, 'ITEM00000002', 'permen', 1, '', 0, 1, 1),
	(5, 1, 'ITEM00000005', 'asdasd', 1, '', 0, 0, 1),
	(6, 1, 'ITEM00000006', 'gula', 2, '', 0, 1, 1),
	(8, 1, 'ITEM00000008', 'coba item2', 5, '', 0, 1, 1),
	(9, 1, 'ITEM00000009', 'sku gen', 1, '2ed0c-cat_face_eyes_113411_1920x1080.jpg', 0, 0, 1);
/*!40000 ALTER TABLE `m_item` ENABLE KEYS */;

-- Dumping structure for table aio_accounting.m_satuan
CREATE TABLE IF NOT EXISTS `m_satuan` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_business` int(11) NOT NULL DEFAULT '0',
  `is_package` bit(1) NOT NULL DEFAULT b'0',
...
-- Dumping data for table aio_accounting.m_satuan: ~3 rows (approximately)
/*!40000 ALTER TABLE `m_satuan` DISABLE KEYS */;
INSERT INTO `m_satuan` (`id`, `id_business`, `is_package`, `id_child`, `qty_child`, `nama`, `status`) VALUES
	(1, 1, b'0', 0, 0, 'pcs', 1),
	(2, 1, b'0', NULL, NULL, 'kg', 1),
	(3, 1, b'1', 1, 10, 'pack1', 0),
	(5, 1, b'1', 1, 10, 'box', 1),
	(6, 1, b'1', 2, 1000, 'Ton', 1),
	(7, 1, b'1', 0, 0, 'Asdf', 0);
/*!40000 ALTER TABLE `m_satuan` ENABLE KEYS */;

-- Dumping structure for table aio_accounting.m_supplier
...
-- Dumping data for table aio_accounting.m_supplier: ~2 rows (approximately)
/*!40000 ALTER TABLE `m_supplier` DISABLE KEYS */;
INSERT INTO `m_supplier` (`id_supplier`, `id_business`, `nama`, `email`, `phone`, `phone_kantor`, `alamat`, `province_id`, `regencies_id`, `district_id`, `status`) VALUES
	(4, 1, 'asdasd', 'mail@mail.com', '1234123123', '12312312312', 'asdasdasd', NULL, 1101, NULL, 1),
	(5, 1, 'yuhu pos', 'yuhu pos@mail.com', '1234123123', '12312312312', 'asdasdasd', NULL, 1101, NULL, 1),
	(6, 1, 'jembersup', 'jembersup@mail.com', '040293402930', '034590349503', 'ksjdfksjdkfjskdjf\r\nkajsdkajskda\r\nsdjfksdjf', NULL, 3509, NULL, 1);
/*!40000 ALTER TABLE `m_supplier` ENABLE KEYS */;

-- Dumping structure for table aio_accounting.stock
CREATE TABLE IF NOT EXISTS `stock` (
  `id_stock` int(11) NOT NULL AUTO_INCREMENT,
  `id_item` int(11) NOT NULL,
  `awal` int(10) NOT NULL,
  `masuk` int(10) NOT NULL DEFAULT '0',
  `jual` int(10) NOT NULL DEFAULT '0',
  `transfer` int(10) NOT NULL DEFAULT '0',
  `penyesuaian` int(10) NOT NULL DEFAULT '0',
  `akhir` int(10) NOT NULL DEFAULT '0',
  `tanggal` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `tanggal_buat` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `status` int(1) NOT NULL,
  PRIMARY KEY (`id_stock`),
  KEY `idproduk` (`id_item`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table aio_accounting.stock: ~0 rows (approximately)
/*!40000 ALTER TABLE `stock` DISABLE KEYS */;
/*!40000 ALTER TABLE `stock` ENABLE KEYS */;

-- Dumping structure for table aio_accounting.tb_districts
CREATE TABLE IF NOT EXISTS `tb_districts` (
  `id` int(7) NOT NULL,
  `regency_id` int(4) NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `regency_id` (`regency_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table aio_accounting.tb_districts: ~7,215 rows (approximately)
/*!40000 ALTER TABLE `tb_districts` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tb_districts` ENABLE KEYS */;

-- Dumping structure for table aio_accounting.tb_provinces
CREATE TABLE IF NOT EXISTS `tb_provinces` (
  `id` int(2) NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table aio_accounting.tb_provinces: ~34 rows (approximately)
/*!40000 ALTER TABLE `tb_provinces` DISABLE KEYS */;
INSERT INTO `tb_provinces` (`id`, `name`) VALUES
	...
	(91, 'PAPUA BARAT'),
	(94, 'PAPUA');
/*!40000 ALTER TABLE `tb_provinces` ENABLE KEYS */;

-- Dumping structure for table aio_accounting.tb_regencies
CREATE TABLE IF NOT EXISTS `tb_regencies` (
  `id` int(4) NOT NULL,
...
-- Dumping data for table aio_accounting.tb_regencies: ~514 rows (approximately)
/*!40000 ALTER TABLE `tb_regencies` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tb_regencies` ENABLE KEYS */;

-- Dumping structure for table aio_accounting._app_values
CREATE TABLE IF NOT EXISTS `_app_values` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `_ci_sessions` (`id`, `ip_address`, `timestamp`, `data`) VALUES
	...
	('6s1364t96ok57elt88lfhv2iujcr89fr', '::1', 1565672372, _binary 0x757365726E616D657C733A353A2261646D696E223B70617373776F72647C733A353A2261646D696E223B),
...
-- Dumping structure for table aio_accounting._jabatan
...
CREATE TABLE IF NOT EXISTS `_menu` (
  ...
  `level` int(11) DEFAULT NULL COMMENT '1 s/d 3',
  `logo` varchar(50) DEFAULT NULL COMMENT 'font awesom',
  `nama` varchar(50) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `_menu_jabatan` (
  `id_menu_jabatan` int(20) NOT NULL AUTO_INCREMENT,
  `id_business` int(11) DEFAULT NULL,
